...
export const pagesSchema = z.array(
    z.string().refine(val => ["/home", "/about", "/blog", "/news", "/contact"].includes(val), {
...
export const homePageContentSchema = z.object({
    ...
    keysBlock: z.object({
        ...
        items: z.array(z.string().min(1, "Item name is required")).min(1, "At least one key item is required"),
