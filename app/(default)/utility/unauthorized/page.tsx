      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
        ...
        <div className="sm:flex sm:justify-between sm:items-center mb-8">
          ...
          <div className="mb-4 sm:mb-0">
            <h1 className="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold">Ups you have no credentials to visit this page </h1>
          </div>
        </div>
        ...
        <div className="border-t border-slate-200 dark:border-slate-700">
          <div className="max-w-2xl m-auto mt-16">
            ...
            <div className="text-center px-4">
              ...
              <h2 className="text-2xl text-slate-800 dark:text-slate-100 font-bold mb-2">Go back to Dashboard</h2>
              <Link href={"/dashboard"}>
              <button className="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                <svg className="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                  <path d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                </svg>
                <span className="ml-2">To dashboard</span>
              </button>
              </Link>
            </div>
