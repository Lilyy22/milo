...
export type UnknownClients = { [storyId: string]: { userId: string, clientName: string, agents: string[] } }

export type StagesSet = "Request" | "Active chat" | "Call accepted" | "Requirements gathered" | "Proposal sent" | "Waiting for response"
...
export type GroupedResult = Record<string, Record<string, IProjectTimeLogResult[]>>;
